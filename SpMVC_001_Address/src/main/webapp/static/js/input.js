...
document.addEventListener("DOMContentLoaded", () => {
   ...
   *
   * 1. 변수1 의 값이 false 가 아니면 변수1 의 값을 왼쪽의 변수에 대입
   * 2. 변수2 의 값이 false 이면 변수2의 값을 비교
   * 3. 변수2 의 값이 false 가 아니면 변수2 의 값을 왼쪽의 변수에 대입
   * ...
   * 4. 변수4 까지 (변수1 ~ 변수4) 모든 변수가 false 인 값을 가지고 있으면
