...
<meta charset="UTF-8">
<title>게시판 글쓰기</title>
<link href="${rootPath}/static/css/input.css?20230712-001" rel="stylesheet">
</head>
<body>
	<form class="main" method="POST" enctype="multipart/form-data">
		...
		<div><label>대표 이미지</label><input name="b_file" type="file" accept="image/*,audio/*,video/*"/></div>
		<div><label>이미지 리스트</label><input name="b_images" type="file" multiple= "multiple" accept="image/*"/></div>
