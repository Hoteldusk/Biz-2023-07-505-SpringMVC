...
public class MemberController {
	...
	public List<MemberDto> name_search(@RequestParam(name = "m_name") String mname) {
		
		List<MemberDto> memberList = memberService.findByName(mname);
		return memberList;
	}

	/*
	 * @ModelAttribute를 생성하면 객체,
	 * 변수가 작용하는 범위(scope)가 Request 전체 영역에 대하여 사용가능한 상태가 된다.
	 */
