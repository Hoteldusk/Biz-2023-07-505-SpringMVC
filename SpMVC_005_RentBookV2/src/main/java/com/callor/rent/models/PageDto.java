...
public class PageDto {
	...
	// Builder 패턴으로 객체를 생성할떄 기본 변수값 생성하기
	@Builder.Default
	private int pageNum = 1; // 보고자 하는 페이지 번호
	
	private int totalCount; // 데이터의 전체 개수
	private int offsetNum; // 시작페이지 번호(기본값 0 부터)
	
	@Builder.Default
	private int limitCount = 10; // 보여질 데이터 개수 ( 기본값 10)
